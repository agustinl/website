<script>
    ...
    const add_class_on_scroll = () => document.querySelector("header").classList.add("bg-in");
    const remove_class_on_scroll = () => document.querySelector("header").classList.remove("bg-in");
